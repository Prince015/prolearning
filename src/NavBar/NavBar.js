...
const navigation = [
    ...
    { name: 'Register Users', href: 'registerUsers', current: false },
]
                                    ...
                                    <div className="flex space-x-4">
                                        ...
                                        <NavLink
                                            ...
                                            className={({ isActive, isPending }) =>
                                                isPending ? "pending" : isActive ? "bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" : "text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium"
                                            }
                                        >
                                            Home
                                        </NavLink>
